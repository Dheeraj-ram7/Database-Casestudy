...
def check():
    ...
    if(c!=[] or s!=[]):
        btn=Button(frame,text="SAVE FILE",command=lambda:[excel(se,cer1,cer2,ced1,ced2,Q)],height=1,width=8,bg="cyan",fg="blue",font="LucidaConsole 11 bold",borderwidth=3).place(x=600,y=600)
